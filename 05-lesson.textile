...
If you think about this from the point of view of substitution, it makes a lot of sense. We'll use an example from Scala's collection types. Where:

<pre>
Buffer[T] <: Seq[T] <: Traversable[T]
</pre>
