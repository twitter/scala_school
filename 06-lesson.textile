...
scala> (new Container(123)).addIt                                               res11: Int = 246
...
res22: java.lang.Object with Container[List] = $anon$1@6982237d
...
<pre>
scala> trait Container[M[_]] { def put[A](x: A): M[A]; def get(m: M[A]: A) }
...
Strange type!  But note now how Ordered is paramterized on *A*, which itself is *Container[A]*
