...
There is Function1 through 22. Why 22? It's an arbitrary magic number
but I've never needed a function with more than 22 arguments so it
works out.

As you see, the syntatic sugar of apply is part of the magic of
object-functional programming. You can pass classes around and use
them as functions.
