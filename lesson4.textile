...
<pre>
scala> val ummThenAhem = (addUmm _) compose (addAhem _)
...
<pre>
scala> val ummThenAhem = (addUmm _) andThen (addAhem _)
ummThenAhem: (String) => java.lang.String = <function1>
...
that reflects whether the PartialFunction is defined over the supplied
argument.
