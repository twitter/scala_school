...
All of these methods below are available all the way down.  The argument and return types won't always look the same as subclasses are free to override them.
