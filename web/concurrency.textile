...
*See Also* <a href="finagle.html">Scala School's Finagle page</a> has plenty of examples of using <code>Future</code>s, including some nice ways to combine them. Effective Scala has opinions about <a href="https://twitter.github.io/effectivescala/#Twitter's standard libraries-Futures">Futures</a> .
