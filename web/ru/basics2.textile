...
*Смотрите также:* В Effective Scala описывается <a href="https://twitter.github.io/effectivescala/index-ru.html#Функциональное программирование-Сопоставление с образцом">когда использовать сопоставление с образцом </a> и <a href="https://twitter.github.io/effectivescala/index-ru.html#Форматирование-Сравнение с образцом">правила форматирования сопоставления с образцом</a>. В "Туре по Scala" также описывается <a href="https://www.scala-lang.org/node/120">Сопоставление с образцом</a>
