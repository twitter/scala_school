...
*Смотрите также:* В Effective Scala описывается как использовать <a href="https://twitter.github.io/effectivescala/index-ru.html#Коллекции">Коллекции</a>.
...
*Смотрите также:* В Effective Scala описывается <a href="https://twitter.github.io/effectivescala/index-ru.html#Функциональное программирование-Разрушение связей (Destructuring bindings)">разрушение связей</a> ("распаковка" кортежа).
...
*Смотрите также:* В Effective Scala описываются <a href="https://twitter.github.io/effectivescala/index-ru.html#Функциональное программирование-Опция">Опции</a>.
...
*Смотрите также:* В Effective Scala описывается <a href="https://twitter.github.io/effectivescala/index-ru.html#Функциональное программирование-`flatMap`">flatMap</a>.
