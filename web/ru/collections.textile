...
В отличие от case классов, у него нет именованных функций доступа, вместо этого у него есть функции доступа, которые носят названия по номеру позиции элемента кортежа и они нумер��тся с 1, а не с 0.
...
flatten сжимает вложенн��е структуры.
...
теперь выберем каждую запись, у которой телефонный код мен��ше 200.
