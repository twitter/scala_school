...
Вы о��ъявляете зависимости с помощью val. SBT использует отражение, чтобы найти все val зависимости в вашем проекте и построить дерево зависимостей во время сборки. Синтаксис может показаться новым, но он эквивалентен тому, что используется в Maven
...
Теперь дав��йте перепишем наш JSON парсер, чтобы он больше соответсвовал действительности
...
h2. Создание пакетов и публи��ация
...
Есть много прим��ров в StandardProject по настройке стандартных значений SBT и добавлению пользовательских задач.
