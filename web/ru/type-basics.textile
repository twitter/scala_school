...
По словам Пирса: "Система типов - это синтаксический способ для автоматической проверки отсутствия определенног�� ошибочного поведения, путем классификации фраз программы по видам значений, которые они вычисляют".
...
Например, без параметрического полиморфизма, общий список структур данных всегда будет выглядеть следующим образом (и э��о действительно выглядело так в Java до введения обобщенных типов):
...
Проще говоря, эт�� означает, что существуют некоторые концепции типов, которые вы захотите использовать в Scala, и которые являются "слишком общими" для компилятора, чтобы он их понял. Предположим, у вас есть некоторые функции
...
Традиционным возражением против стати��еской типизации является то, что она имеет много синтаксических накладных расходов. Scala снимает это ограничение путем предоставления _вывода типа_.
...
Но м�� хотим сделать ковариантным тип T:
